/* ============================================================
   ...
   POSDemo, IndustriesToggle, FeatureTabs, DTECalculator, ModuleBuilder
   ============================================================ */
...
// ── Industries Toggle ──────────────────────────────────────
export function IndustriesToggle() {
...
const FEATURES = [
  {
    num: '01',
    name: 'POS',
    title: <React.Fragment>Caja registradora <em>ultra rápida.</em></React.Fragment>,
  ...
  },
  {
    num: '02',
    name: 'DTE',
    title: <React.Fragment>Hacienda contesta <em>en segundos.</em></React.Fragment>,
  ...
  },
  {
    num: '03',
    name: 'Inventario',
    title: <React.Fragment>Kardex que no <em>se pelea</em> con tu bodega.</React.Fragment>,
  ...
  },
  {
    num: '04',
    name: 'Reportes',
    title: <React.Fragment>Tus números, <em>sin Excel.</em></React.Fragment>,
  ...
  },
  {
    num: '05',
    name: 'Equipo',
    title: <React.Fragment>Cada quien ve <em>lo suyo.</em></React.Fragment>,
...
export function DTECalculator() {
  const [sliderIdx, setSliderIdx] = React.useState(7);
          ...
          {selected.size === 0 && extraBranches === 0 ? (
            ...
            <>
              ...
              {discPct === 0 && selected.size >= 2 && selected.size < 3 && (
                <div className="mb-upsell">Agregá 1 módulo más y ahorrás 10% en todo el plan</div>
              )}
              {discPct === 10 && selected.size < 5 && (
                <div className="mb-upsell">Con {5 - selected.size} módulo{5 - selected.size > 1 ? 's' : ''} más subís al 15% de descuento</div>
              )}
            </>
          )}
        </div>
